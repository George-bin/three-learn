<template>
  <div class="rotation-wooden-case-component">
...
export default {
  ...
  methods: {
    ...
    initCamera () {
      ...
      window.camera = new THREE.PerspectiveCamera( 70, k, 1, 1000 );
    ...
    createMesh() {
      ...
      // texture
      let texture = new THREE.TextureLoader().load('../../../static/img/textures/crate.gif');
