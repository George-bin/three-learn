<template>
  <div class="coordinate-component">
...
export default {
  ...
  methods: {
    ...
    createMesh() {
      ...
      let wordScale = new THREE.Vector3();
      mesh1.getWorldScale(wordScale);
      console.log('模型本地坐标:', mesh1.position);
      console.log('模型世界坐标:', worldPosition);
      console.log('模型本地缩放系数:', mesh1.scale)
      console.log('模型世界缩放系数:', wordScale)
    },
    // 窗口大小变换重新进行绘制
    canvasResize() {
      let s = this.s;
